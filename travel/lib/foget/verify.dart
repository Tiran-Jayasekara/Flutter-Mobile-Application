...
import 'package:travel/foget/reset.dart';
...
class _VerifyState extends State<Verify> {
  ...
  fontSize: 16,
      ...
      var url =  "http://localhost/flutter/reset.php"/*"http://192.168.0.127/flutter/reset.php"*/;
      ...
      if(data == "success"){
        ...
        Fluttertoast.showToast(msg: "You Are Not Register Customer",toastLength: Toast.LENGTH_SHORT,
          gravity: ToastGravity.CENTER,
          fontSize: 16,
        );
      }
